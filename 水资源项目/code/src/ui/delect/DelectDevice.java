...
//	}
	...
	private void createContents() {
		...
		frame = new JFrame("Delete Device");
		//frame.setModal(true);
...
//		thread.start();
		   ...
		   buildTable();
			menuItem1.setLabel("Delect This");
...
//		 } 
  public void buildTable(){
		...
		int row=StaticContext.devList.size();
...
//	 }	
		...
		table_1.setValueAt(StaticContext.devList.get(i).getName(),i,1);
