...
public class ScrollFrame extends DragControl implements PreRenderable, Renderable
{
    ...
    protected static final Size DEFAULT_MAXIMIZED_SIZE = Size.fromPixels(200, 300);
    ...
    public FrameResizeControl getFrameResizeControl() {
		return frameResizeControl;
	}

	public void setFrameResizeControl(FrameResizeControl frameResizeControl) {
		this.frameResizeControl = frameResizeControl;
	}
